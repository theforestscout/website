...
<div class="media author-bio">
	<div class="pull-left" style="width: 100px; height: 100px;">
		<div class="border-right">
			<?php echo get_avatar($id, 96, '', '', null); ?>
		</div>
	</div>
	<div class="bio-data media-body">
		...
		<div class="flex_grid recent-contributions">
			...
			if ($my_query->have_posts()): ?>
				...
				$my_query->the_post(); ?>
				<span class="d-block mt-5"><a href="<?php the_permalink() ?>" rel="bookmark" title="Permenent Link To <?php the_title_attribute(); ?>"><?php the_title(); ?><small class="latest-sm">&nbsp;(<?php the_time('m.d.y') ?>)</small></a></span>
				<?php endwhile; ?>
				<?php endif; ?>
			</div><!-- // .flex_col-* -->
			<div class="buttons flex_col-3_xs-12">
				<div class="social fa-social-color">
				<?php
				if ($email) 
